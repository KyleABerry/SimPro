	...
	protected void onCreate(Bundle savedInstanceState)
	{
        ...
        meteorB.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				intent.putExtra("aniCount", 0);
				intent.putExtra("time",timeInWeeks);
				
				}catch(Exception e)
				{
					System.out.println(e);
					intent.putExtra("aniCount", -1);
        ...
        endB.setOnClickListener(new OnClickListener(){
			public void onClick(View v){
				...
				intent.putExtra("aniCount", humans.count+pterodactyl.count+stegosaurus.count+trex.count);
				intent.putExtra("time",timeInWeeks);
